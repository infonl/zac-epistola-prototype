...
| Kolom | Type | Null | Toelichting |
|---|---|---|---|
| `epistola_ingeschakeld` | boolean | ja | Poort per zaaktype, spiegelt `smartdocuments_ingeschakeld` |
...
### Open: is een opgeslagen naam nodig?

SmartDocuments slaat geen weergavenaam op, dus ZAC kan geen templatelijst tonen wanneer de bovenstroomse
API onbereikbaar is, en een verweesde mapping blijft onzichtbaar tot iemand het scherm opent. Dat getrouw
...
geverifieerd; nieuwe structuren zijn ontwerpintentie en nog niet gemigreerd.
