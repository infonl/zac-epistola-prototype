...
enum class ErrorCode(val value: String) {
    ...
    ERROR_CODE_FILE_TOO_LARGE_TO_OPEN("msg.error.file.too-large-to-open"),
    ...
    ERROR_CODE_BPMN_PROCESS_DEFINITION_DOWNLOAD_FAILED("msg.error.bpmn.process.definition.download.failed"),
    ...
    ERROR_CODE_ENKELVOUDIGINFORMATIEOBJECT_CONVERSION_FAILED("msg.error.enkelvoudiginformatieobject.conversion.failed"),
    ERROR_CODE_ENKELVOUDIGINFORMATIEOBJECT_DOWNLOAD_FAILED("msg.error.enkelvoudiginformatieobject.download.failed"),
    ERROR_CODE_DETACHED_DOCUMENT_NOT_FOUND("msg.error.detached.document.not.found"),
